...
def test_lbf_heuristic() -> None:
    ...
    agent1_fruit = [[(5, 1), (5, 8)], [(15, 4), (15, 6)], [(13, 9), (14, 12), (13, 12), (13, 14)], [(5, 14), (5, 16), (6, 16)]]
    agent2_fruit = [[(2, 2), (4, 6)], [(12, 4), (12, 3), (16, 5)], [(15, 11), (15, 15)], [(8, 11), (2, 11), (2, 14)]]
    agent3_fruit = [[(2, 4), (2, 6)], [(10, 1), (11, 6)], [(12, 10), (12, 13), (12, 15), (14, 16)], [(7, 12), (6, 13), (3, 12), (3, 15), (3, 16), (5, 17)]]
    ...
    total_reward = 0
    for _ in range(1000):
        actions = [agent1.act(env.agents[0].pos, env.current_room, env.grid), 
