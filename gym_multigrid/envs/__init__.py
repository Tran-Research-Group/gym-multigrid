...
from gym_multigrid.envs.collect_game import CollectGameRooms
from gym_multigrid.envs.collect_game import CollectGameRoomsFixedHorizon
from gym_multigrid.envs.collect_game import CollectGameRoomsRespawn
